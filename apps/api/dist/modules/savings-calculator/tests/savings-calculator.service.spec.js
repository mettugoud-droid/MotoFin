...
describe('SavingsCalculatorService', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                savings_calculator_service_1.SavingsCalculatorService,
                emi_calculator_service_1.EmiCalculatorService,
                vehicle_valuation_service_1.VehicleValuationService,
                { provide: bank_rates_service_1.BankRatesService, useValue: mockBankRatesService },
                { provide: savings_calculation_repository_1.SavingsCalculationRepository, useValue: mockRepository },
            ],
        }).compile();
        service = module.get(savings_calculator_service_1.SavingsCalculatorService);
        bankRatesService = module.get(bank_rates_service_1.BankRatesService);
        repository = module.get(savings_calculation_repository_1.SavingsCalculationRepository);
    });
    ...
    describe('calculateSavings', () => {
        ...
        it('should throw ServiceUnavailableException when no bank rates', async () => {
            ...
            await expect(service.calculateSavings(validDto)).rejects.toThrow(common_1.ServiceUnavailableException);
        });
...
//# sourceMappingURL=savings-calculator.service.spec.js.map