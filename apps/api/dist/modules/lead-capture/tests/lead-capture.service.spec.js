...
describe('LeadCaptureService', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                lead_capture_service_1.LeadCaptureService,
                { provide: lead_repository_1.LeadRepository, useValue: mockLeadRepo },
                { provide: savings_calculation_repository_1.SavingsCalculationRepository, useValue: mockSavingsCalcRepo },
            ],
        }).compile();
        service = module.get(lead_capture_service_1.LeadCaptureService);
        leadRepository = module.get(lead_repository_1.LeadRepository);
        savingsCalcRepository = module.get(savings_calculation_repository_1.SavingsCalculationRepository);
    });
    ...
    describe('captureLead', () => {
        ...
        it('should classify foreclosure calculator as balance_transfer_opportunity', async () => {
            ...
            leadRepository.getLeadSourceByType.mockResolvedValue({ ...mockLeadSource, type: 'foreclosure_calculator' });
        ...
        it('should throw NotFoundException when lead source not found', async () => {
            ...
            await expect(service.captureLead(validDto)).rejects.toThrow(common_1.NotFoundException);
        });
        ...
        it('should link savings calculation to lead after capture', async () => {
            await service.captureLead(validDto);
            expect(savingsCalcRepository.markLeadCaptured).toHaveBeenCalledWith('savings-calc-id', 'new-lead-uuid');
        });
...
//# sourceMappingURL=lead-capture.service.spec.js.map